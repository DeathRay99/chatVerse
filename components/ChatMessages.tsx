  ...
  return (
    <div className="p-5">
      {!loading && messages?.length === 0 && (
        <div
          className="flex flex-col justify-center text-center items-center p-20 rounded-xl space-y-2 bg-indigo-400
          ...
          <div key={message.id} className="flex my-2 items-end">
            ...
            >
              ...
              <div className="flex space-x-2">
                ...
                {!message.translated && <p className="text-xs italic font-extralight line-clamp-1 text-yellow-500 ">loading...</p>}
              </div>
            </div>
            <UserAvatar
